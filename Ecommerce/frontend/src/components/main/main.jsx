...
const Main = () => {
    ...
    const allPriductsAPI = "products?populate=*"
    ...
    const [myDate, setmyDate] = useState(allPriductsAPI);
        ...
        return (
            <Container sx={{ py: 9 }}>
                <Stack direction={"row"} alignContent={"center"} justifyContent={"space-between"} flexWrap={"wrap"} gap={3}>
                    ...
                    >
                        <ToggleButton sx={{ color: theme.palette.text.primary }} className="myButton" value={allPriductsAPI} aria-label="left aligned">
                            All Products
                        </ToggleButton>
                        ...
                        {data.data.map((item) => {
                            return (
                                <Card
                                    ...
                                    key={item.id} sx={{ maxWidth: 333, mt: 6, ":hover .MuiCardMedia-root": { rotate: "1deg", scale: "1.1", transition: "0.35s" } }}>
                                    <CardMedia
                                        sx={{ height: 277 }}
